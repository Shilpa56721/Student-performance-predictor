...
# Add the project root to sys.path so Python can find the 'src' module.
...
class DataIngestionConfig:
    # Using project_root to create absolute paths
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            # Using project_root and os.path.join for OS-independent absolute paths
